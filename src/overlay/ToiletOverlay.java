...
public class ToiletOverlay extends Overlay{
	...
	public ToiletOverlay(GraphicManager graphicManager, Player player, String t) {
		...
		// Buttons
	    buttons = new JLabel();
        buttons.setIcon(new ImageIcon(graphicManager.toiletButton.getImage(0,0)));
        buttons.setBounds(BufferedImageLoader.scaleToScreenX(700,false), BufferedImageLoader.scaleToScreenY(100,false), BufferedImageLoader.scaleToScreenX(275,false), BufferedImageLoader.scaleToScreenY(55,false));
        actions = new Act(5, new ImageIcon(graphicManager.toiletButton.getImage(0,0)), new ImageIcon(graphicManager.toiletButton.getImage(0,1)));
		...
		bench.setIcon(new ImageIcon(graphicManager.toiletOverlay.getImage()));
	...
	public void setVisible(boolean on) {
		...
		if (player != null)
			player.setVisible(!on);	// Figur ausblenden
	}

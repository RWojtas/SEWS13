...
public class DancefloorOverlay extends Overlay{
	...
	public DancefloorOverlay(GraphicManager graphicManager, Player player, String t) {
		...
		button.setBounds(BufferedImageLoader.scaleToScreenX(700,false), BufferedImageLoader.scaleToScreenY(100,false), BufferedImageLoader.scaleToScreenX(275,false), BufferedImageLoader.scaleToScreenY(55,false));

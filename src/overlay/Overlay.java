...
public class Overlay extends JLayeredPane {
	...
	public Overlay(final GraphicManager graphicManager, String t) {
		...
		title.setBounds(BufferedImageLoader.scaleToScreenX(35,false), BufferedImageLoader.scaleToScreenY(20,false), BufferedImageLoader.scaleToScreenX(700,false), BufferedImageLoader.scaleToScreenY(48,false));

		close = new JLabel();
		Icon close_icon = new ImageIcon(graphicManager.closeButtons.getImage(0,
				0));
		close.setIcon(close_icon);
		close.setBounds(cont_width - BufferedImageLoader.scaleToScreenX(60,false), BufferedImageLoader.scaleToScreenY(10,false), BufferedImageLoader.scaleToScreenX(45,false), BufferedImageLoader.scaleToScreenY(45,false));
